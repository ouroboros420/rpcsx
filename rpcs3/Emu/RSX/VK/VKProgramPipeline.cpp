...
namespace vk
{
	...
	namespace glsl
	{
		...
		program& program::bind(const vk::command_buffer& cmd, VkPipelineBindPoint bind_point)
		{
			...
			VK_GET_SYMBOL(vkCmdBindPipeline)(cmd, bind_point, m_pipeline);
			VK_GET_SYMBOL(vkCmdBindDescriptorSets)(cmd, bind_point, m_pipeline_layout, 0, count, bind_sets, 0, nullptr);
			return *this;
		}
